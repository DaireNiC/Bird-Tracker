...
/**
 ...
 |--------------------------------------------------
 */
export const createPost = ({ title, description, date, eggCount }) => {
  ...
  return (dispatch) => {
    ...
    firebase.database().ref(`/users/${currentUser.uid}/post`)
      .push({ title, description, date, eggCount })
      .then(() => {
...
export const updatePost = ({ title, description, date, eggCount, uid }) => {
  const { currentUser } = firebase.auth();
  ...
  return (dispatch) => {
    ...
    firebase.database().ref(`/users/${currentUser.uid}/post/${uid}`)
      .set({ title, description, date, eggCount })
      .then(() => {
